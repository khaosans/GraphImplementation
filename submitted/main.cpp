...
//# 9 Item to be implemeted --All comments
...
//--------------------------------------------------------------------------
/* #2 Item to be implemented
   This is my read input section. It allows for singleton or pair (directed).  
*/
     do{
          get_input(num1,num2);
          build(num1,num2);
...
//--------------------------------------------------------------------------
/* #3 Item to be implemented
   The functions void adjacent(link_ptr_tp head_link) is used to 
   find all the sucessors  for a head_link ptr;

*/
void adjacent(link_ptr_tp head_link)
//function used to print out the adjacent nodes
{
...
//--------------------------------------------------------------------------
/* #4 Item to be implemented
   The vistor functions vists every node of the graph and calls an
   adjacent function which display all the adjacent nodes.  It is a 
   function withing a function that allows for visiting every node,
   and visiting every successor if one exist or not.  
*/
...
//-------------------------------------------------------------------------- 
/* #1 items to be implemented
str_node_tp is dynamically allocted using the new keyword instead of
using (node_ptr_tp) malloc( NODE_SIZE). Because this is C++,
I did not find any use for NODE_SIZE and #define LINK_SIZE sizeof( str_link_tp )
*/
